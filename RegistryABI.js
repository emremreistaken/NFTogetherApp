const RegistryABI = [
    {
        inputs: [
            { internalType: "uint64", name: "vrfSub", type: "uint64" },
            {
            ...
            { internalType: "address", name: "umaV3", type: "address" },
        ],
        stateMutability: "nonpayable",
        type: "constructor",
    },
    { inputs: [], name: "AccountAlreadyCreated", type: "error" },
    { inputs: [], name: "AccountNotFound", type: "error" },
    { inputs: [], name: "EmptyRound", type: "error" },
    { inputs: [], name: "InitializationFailed", type: "error" },
    { inputs: [], name: "InsufficientPrize", type: "error" },
    { inputs: [], name: "InvalidAmount", type: "error" },
    { inputs: [], name: "InvalidChain", type: "error" },
    { inputs: [], name: "InvalidNFTOwner", type: "error" },
    { inputs: [], name: "InvalidTicketOperation", type: "error" },
    ...
    { inputs: [], name: "RoundNotFinished", type: "error" },
    { inputs: [], name: "RoundNotFound", type: "error" },
    { inputs: [], name: "TicketNotFound", type: "error" },
    { inputs: [], name: "WinnerNotFound", type: "error" },
    {
        anonymous: false,
        inputs: [
            {
    ...
    },
    {
        inputs: [
            ...
            { internalType: "bool", name: "useMockPrize", type: "bool" },
        ],
        name: "finishRound",
        outputs: [],
        stateMutability: "nonpayable",
